...
export function drawColoredDemo(renderer: Renderer, time: number, w: number, h: number): void {
  drawHudPanel(renderer, 40, 40, 200, 120, [80, 180, 255]);
  drawHudPanel(renderer, 300, 60, 220, 120, [255, 180, 80]);
  drawHudPanel(renderer, w - 320, 40, 260, 140, [70, 220, 200]);
  ...
  drawHudPanel(renderer, w - 360, h - 220, 300, 160, [120, 200, 255]);
